...
*/
console.log( 'O resultado da soma é:', sum( (numb1, numb2) => { return numb1 + numb2 } ));
// ?
...
*/
var subtraction = calculator(3,9);
var multiplication = calculator(8,15);
var division = calculator(10,4);
var mod = calculator(133,9);
/*
...
console.log( 'O resultado da subtração é:', subtraction( (numb1, numb2) => { return numb1 - numb2 }) );
// ?
console.log( 'O resultado da multiplicação é:', multiplication( (numb1, numb2) => { return numb1 * numb2 }) );
// ?
console.log( 'O resultado da divisão é:', division( (numb1, numb2) => { return numb1 / numb2 }) );
// ?
console.log( 'O resto da divisão é:' , mod( (numb1, numb2) => { return numb1 % numb2 }) );
// ?